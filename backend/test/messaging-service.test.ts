...
import { createSupabaseMessagingService, type MessagingConversation, type MessagingMessage } from '../src/services/messaging-service.js';
...
describe('MessagingService', () => {
  ...
  describe('listConversations', () => {
    it('should list all conversations for the authenticated user', async () => {
      ...
      expect(mockRpc).toHaveBeenCalledWith('list_my_conversations', {});
  ...
  describe('getConversation', () => {
    it('should get a conversation by ID', async () => {
      ...
      expect(mockRpc).toHaveBeenCalledWith('get_conversation', { cid: 'conv-1' });
  ...
  describe('getOrCreateBookingConversation', () => {
    it('should get or create a conversation for a booking', async () => {
      ...
      expect(mockRpc).toHaveBeenCalledWith('get_or_create_booking_conversation', { p_booking_id: 'bk-123' });
      expect(result).toEqual({ status: 'ok', data: mockConversation });
    });
  ...
  describe('listMessages', () => {
    it('should list messages for a conversation with default limit', async () => {
      ...
      expect(mockRpc).toHaveBeenCalledWith('list_conversation_messages', { cid: 'conv-1', p_limit: 100 });
  ...
  describe('markRead', () => {
    it('should mark conversation as read', async () => {
      ...
      expect(mockRpc).toHaveBeenCalledWith('mark_conversation_read', { cid: 'conv-1' });
  ...
  describe('error classification', () => {
    it('should classify forbidden error by code 42501', async () => {
      const forbiddenError = { code: '42501', message: 'some privilege error' };
      mockRpc.mockResolvedValueOnce({ data: null, error: forbiddenError });
      mockRpc.mockResolvedValueOnce({ data: null, error: forbiddenError });
      mockRpc.mockResolvedValueOnce({ data: null, error: forbiddenError });
