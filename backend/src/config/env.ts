...
const schema = z.object({
  ...
  POST_PUBLISH_RATE_LIMIT_MAX: positiveInteger("POST_PUBLISH_RATE_LIMIT_MAX").default(30),
  POST_READ_RATE_LIMIT_MAX: positiveInteger("POST_READ_RATE_LIMIT_MAX").default(120),
  ...
  HOST_CENTER_RATE_LIMIT_MAX: positiveInteger("HOST_CENTER_RATE_LIMIT_MAX").default(120),
