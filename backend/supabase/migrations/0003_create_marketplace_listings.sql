...
drop policy if exists "creators insert own marketplace listings" on public.marketplace_listings;
...
drop policy if exists "creators update own marketplace listings" on public.marketplace_listings;
