# tutoria-server-authoritative-ui — Maintenance Spec
...
## Non-goal
No client-authoritative capacity/payment/lifecycle truth.

## Evaluation prompts / acceptance scenarios
- Stale capacity conflict is rendered from server error without fabricated success.
