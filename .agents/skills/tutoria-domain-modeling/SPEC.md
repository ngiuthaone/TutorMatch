# tutoria-domain-modeling — Maintenance Spec
...
## Non-goal
No persistence, provider integration, notification delivery, or fake concurrency enforcement.

## Evaluation prompts / acceptance scenarios
- Pure lifecycle change preserves state boundaries and lists production gaps.
