# tutoria-external-reference — Maintenance Spec
...
## Non-goal
No architecture copying by default and no license laundering through AI rewrites.

## Evaluation prompts / acceptance scenarios
- Restricted external implementation becomes STUDY_ONLY feature specification, not ported code.
