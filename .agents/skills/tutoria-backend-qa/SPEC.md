# tutoria-backend-qa — Maintenance Spec
...
## Non-goal
No claim that pure unit tests prove production transaction safety.

## Evaluation prompts / acceptance scenarios
- Race and retry tests produce reproducible evidence and mark untestable boundaries UNVERIFIED.
