# tutoria-rls-review — Maintenance Spec
...
## Non-goal
No UI-only authorization or self-certification of risky policy.

## Evaluation prompts / acceptance scenarios
- Learner cannot read another learner booking; host cannot mutate another host session.
