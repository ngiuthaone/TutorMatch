# tutoria-production-reliability — Maintenance Spec
...
## Non-goal
No distributed infrastructure added only for sophistication.

## Evaluation prompts / acceptance scenarios
- Succeeded DB mutation with failed downstream delivery remains recoverable and observable.
