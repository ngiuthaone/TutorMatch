...
function makeBrowseTutorProfile({
  name,
  role,
  tagline,
  image,
  ...
  subjects,
  about,
}: Pick<TutorProfile, "name" | "role" | "tagline" | "image" | "rating" | "reviewCount" | "lessons" | "responseTime" | "location" | "price" | "languages" | "subjects" | "about">): TutorProfile {
  return {
    name,
    role,
    tagline,
...
export const tutorProfiles: TutorProfile[] = [
  ...
  makeBrowseTutorProfile({
    ...
    about: ["I help learners build Korean skills for daily life, study, and confident conversation.", "Lessons combine TOPIK-informed structure with plenty of guided speaking practice."],
  }),
  makeBrowseTutorProfile({
    name: "Tuan Anh",
    ...
    about: ["I coach students through mathematics and physics with step-by-step methods that make difficult ideas manageable.", "We use targeted practice to build accuracy, confidence, and durable problem-solving habits."],
  }),
  makeBrowseTutorProfile({
    name: "Minh Tri",
    ...
    about: ["I am a conservatory-trained pianist helping learners turn focused practice into musical fluency.", "Sessions balance technique, repertoire, theory, and the habits that support long-term progress."],
  }),
  makeBrowseTutorProfile({
    name: "Phuong Thao",
    ...
    about: ["I help emerging designers develop clear visual decisions for products, brands, and portfolios.", "We work through real briefs, critique your work directly, and create a focused plan for improvement."],
  }),
  makeBrowseTutorProfile({
    name: "Hoang Nam",
    role: "Fitness Coach",
    ...
    about: ["I support learners who want to get stronger and feel more capable without a complicated fitness plan.", "Sessions are tailored to your experience, mobility, goals, and the time you can genuinely commit."],
  }),
  makeBrowseTutorProfile({
    name: "Kim Chi",
    ...
    about: ["I help students build fluent, practical English for work, study, and everyday conversations.", "You will get focused speaking time, useful corrections, and a plan that keeps your progress moving."],
  }),
  makeBrowseTutorProfile({
    name: "Dang Khoa",
    role: "Data Scientist",
    ...
    about: ["I help learners move from notebooks and tutorials to data projects that solve meaningful problems.", "Sessions focus on sound fundamentals, clear experiments, and the engineering habits behind trustworthy results."],
  }),
];
