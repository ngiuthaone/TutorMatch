...
const potteryDetail: Omit<EventDetail, keyof EventListing> = {
  ...
  plan: [
    { title: "Welcome and introduction", duration: "15 min", description: "Meet your host and the other participants, review the materials, and cover studio safety.", image: "/images/pottery-workshop-hero-optimized.jpg" },
    { title: "Pottery demonstration", duration: "20 min", description: "Watch a live demonstration of the techniques you will use during the session.", image: "/images/pottery-workshop-class-optimized.jpg" },
    { title: "Guided hand-building", duration: "60 min", description: "Create your cup with individual guidance and support from your host.", image: "/images/pottery-workshop-hero-optimized.jpg" },
    { title: "Decoration and glazing", duration: "40 min", description: "Refine your piece, choose a glaze, and prepare your work for firing.", image: "/images/pottery-workshop-class-optimized.jpg" },
  ],
  faqs: [
...
const pizzaDetail: Omit<EventDetail, keyof EventListing> = {
  ...
  plan: [
    {
      title: "Welcome and ingredient introduction",
      duration: "15 min",
      description: "Meet the Pizza 4P’s workshop team, get comfortable in the kitchen, and learn how the dough, sauces, cheeses, and seasonal toppings will be used throughout the session.",
      image: "https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&w=1200&q=90",
    },
    {
      title: "Dough-stretching demonstration",
      duration: "25 min",
      description: "Watch a chef demonstrate how to open and stretch fermented dough by hand, keep the crust airy, and prepare the base for sauce and toppings without overworking it.",
      image: "https://images.unsplash.com/photo-1565299507177-b0ac66763828?auto=format&fit=crop&w=1200&q=90",
    },
    {
      title: "Build your own pizza",
      duration: "60 min",
      description: "Stretch your dough, spread sauce, choose cheeses, and balance toppings with one-on-one guidance from the chefs so your pizza bakes evenly and tastes balanced.",
      image: "https://images.unsplash.com/photo-1511689660979-10d2b1aada49?auto=format&fit=crop&w=1200&q=90",
    },
    {
      title: "Bake, taste, and wrap up",
      duration: "50 min",
      description: "See how the high-heat oven finishes your pizza, enjoy the tasting together, and leave with a recipe card plus practical tips for recreating the process at home.",
      image: "https://images.unsplash.com/photo-1541745537411-b8046dc6d66c?auto=format&fit=crop&w=1200&q=90",
    },
  ],
  faqs: [
...
export function getEventBySlug(slug: string): EventDetail | undefined {
  ...
  if (event.slug === "pizza-4ps-pizza-making-workshop") return { ...event, ...pizzaDetail };
