(function () {
  ...
  const defaults = {
    learnerLevels: ["Complete beginners", "Developing learners", "Advanced learners"],
    ageGroups: ["Teenagers", "University students", "Adults", "Professionals"],
    teachingStyles: ["Guided practice", "Personalized feedback", "Goal-based sessions", "Progress planning"],
    outcomes: ["Build practical confidence", "Improve core skills", "Make steady progress", "Apply learning independently"],
    typicalLesson: "We start with your current goal, work through one focused skill with guided practice, then finish with clear feedback and a practical next step.",
    reviews,
  };

  const compact = (profile) => ({ ...defaults, ...profile, reviews });
  ...
  const profiles = [
    ...
    compact({
      ...
      price: 400000,
      languages: ["Vietnamese (Native)", "English (Conversational)", "French (Conversational)"],
    ...
    compact({
      ...
      price: 300000,
      languages: ["Vietnamese (Native)", "English (Fluent)"],
      subjects: ["Vietnamese cuisine", "Baking", "French culinary", "Cooking"],
      about: [
    ...
    compact({
      ...
      subjects: ["Music production", "Ableton", "Sound design", "Music theory"],
      about: [
    ...
    compact({
      ...
      price: 450000,
      languages: ["Vietnamese (Native)", "English (Fluent)", "Korean (Conversational)"],
    ...
    compact({
      ...
      tagline: "Learn Korean with clear structure, supportive speaking practice, and confidence for real conversations.",
      ...
      location: "Cau Giay, Ha Noi",
      price: 180000,
      languages: ["Vietnamese (Native)", "Korean (Fluent)", "English (Fluent)"],
      subjects: ["Korean", "English conversation", "Vietnamese"],
      about: [
        "I help learners build Korean skills for daily life, study, and confident conversation.",
        "Lessons combine TOPIK-informed structure with plenty of guided speaking practice.",
      ],
    }),
    compact({
      name: "Tuan Anh",
      role: "Mathematics Tutor",
      tagline: "Build strong mathematical thinking through clear explanations, practice, and patient problem-solving.",
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=900&q=85",
      rating: 4.6,
      reviewCount: 320,
      lessons: 400,
      ...
      about: [
        "I coach students through mathematics and physics with step-by-step methods that make difficult ideas manageable.",
        "We use targeted practice to build accuracy, confidence, and durable problem-solving habits.",
      ],
    }),
    compact({
      name: "Minh Tri",
      role: "Piano Instructor",
      tagline: "Develop musical confidence with expressive piano technique, attentive listening, and consistent practice.",
      image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=900&q=85",
      rating: 4.9,
      reviewCount: 670,
      lessons: 2000,
      ...
      location: "Tay Ho, Ha Noi",
      price: 350000,
      languages: ["Vietnamese (Native)", "English (Fluent)", "French (Conversational)"],
      subjects: ["Piano", "Music theory"],
      about: [
        "I am a conservatory-trained pianist helping learners turn focused practice into musical fluency.",
        "Sessions balance technique, repertoire, theory, and the habits that support long-term progress.",
      ],
    }),
    compact({
      name: "Phuong Thao",
      role: "Graphic Design Mentor",
      tagline: "Strengthen your design eye and make more purposeful visual work for portfolios and real projects.",
      image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=900&q=85",
      rating: 4.7,
      reviewCount: 580,
      lessons: 750,
      ...
      location: "Hoan Kiem, Ha Noi",
      price: 320000,
      languages: ["Vietnamese (Native)", "English (Fluent)", "Japanese (Conversational)"],
      subjects: ["Graphic design", "UI/UX design", "Illustration", "Animation"],
      about: [
        "I help emerging designers develop clear visual decisions for products, brands, and portfolios.",
        "We work through real briefs, critique your work directly, and create a focused plan for improvement.",
      ],
    }),
    compact({
      name: "Hoang Nam",
      role: "Fitness Coach",
      tagline: "Build strength, better movement, and sustainable habits with coaching that fits your real routine.",
      image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=900&q=85",
      rating: 4.5,
      reviewCount: 230,
      lessons: 600,
      ...
      about: [
        "I support learners who want to get stronger and feel more capable without a complicated fitness plan.",
        "Sessions are tailored to your experience, mobility, goals, and the time you can genuinely commit.",
      ],
    }),
    compact({
      name: "Kim Chi",
      role: "English Conversation Coach",
      tagline: "Speak English more naturally through practical conversation, precise feedback, and useful weekly practice.",
      image: "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?auto=format&fit=crop&w=900&q=85",
      rating: 4.8,
      reviewCount: 1100,
      lessons: 1400,
      ...
      price: 190000,
      languages: ["Vietnamese (Native)", "English (Fluent)"],
      subjects: ["IELTS", "English", "English conversation", "Presentation skills"],
      about: [
        "I help students build fluent, practical English for work, study, and everyday conversations.",
        "You will get focused speaking time, useful corrections, and a plan that keeps your progress moving.",
      ],
    }),
    compact({
      name: "Dang Khoa",
      role: "Data Scientist",
      tagline: "Learn practical data science by connecting Python, machine learning, and clear thinking about real problems.",
      image: "https://images.unsplash.com/photo-1519345182560-3f2917c472ef?auto=format&fit=crop&w=900&q=85",
      rating: 4.7,
      reviewCount: 340,
      lessons: 420,
      ...
      price: 420000,
      languages: ["Vietnamese (Native)", "English (Fluent)"],
      subjects: ["Python", "Data science", "JavaScript", "Node.js"],
      about: [
        "I help learners move from notebooks and tutorials to data projects that solve meaningful problems.",
        "Sessions focus on sound fundamentals, clear experiments, and the engineering habits behind trustworthy results.",
      ],
    }),
  ];

  document.documentElement.dataset.tutorProfiles = JSON.stringify(profiles);

  const getTutorProfile = function getTutorProfile(name) {
    const decodedName = decodeURIComponent(String(name || "").replace(/\+/g, " ")).trim();
    return profiles.find((profile) => profile.name === decodedName) || profiles[0];
  };
  try {
    window.TUTORIA_TUTOR_PROFILES = profiles;
    window.TUTORIA_GET_TUTOR_PROFILE = getTutorProfile;
  } catch {
    // The profile adapter can read from documentElement.dataset instead.
  }
})();
